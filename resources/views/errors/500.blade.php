...
<body>
    ...
    <section>
        <div class="flex flex-col items-center justify-center  bg-gray-100 text-center px-8 py-28">
            <img src="{{ asset('500.png') }}" alt="404 Illustration" class="md:max-w-xl w-full" draggable="false">
            <p class="text-xl  text-red-600 mt-4 font-bold">Oops! Terjadi kesalahan pada server.</p>
